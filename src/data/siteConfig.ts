...
export const siteConfig = {
  ...
  social: {
    ...
    instagram: '',
    youtube: '',
    github: 'https://github.com/kanithasri21/src/portfolio',
  },
  ...
  about: {
    summary:
      'I am a passionate B.Tech student interested in software development and learning new technologies. I enjoy coding and continuously improving my technical skills to build innovative solutions.',
